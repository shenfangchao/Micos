                          ...
                          child: Column(
                            children: [
                                  ...
                                  children: [
                                    Align(
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: Image.asset(
                                          VqweghvhjvjGvhgavsufvhg().xmcvklhjdjkrhjktg.cjvkbhjkhjrhewjew!,
                                          width: 70,
                                          height: 70,
                                          fit: BoxFit.cover,
                                        ),
                                    ...
                                    Align(
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: CachedNetworkImage(
                                          imageUrl: VqweghvhjvjGvhgavsufvhg().xmcvklhjdjkrhjktg.xhughugrvehgdvf!,
                                          width: 36,
                                          height: 36,
                                          fit: BoxFit.cover,
                                        ),
                              ...
                              Padding(
                                ...
                                child: Text(
                                  VqweghvhjvjGvhgavsufvhg().xmcvklhjdjkrhjktg.nakfsdohgiuhjxcfgds!,
                                  style: const TextStyle(
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: Text(
                                    VqweghvhjvjGvhgavsufvhg().xmcvklhjdjkrhjktg.hurehbghjdhjxhgv!,
                                    style: const TextStyle(
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    GestureDetector(
                                      onTap: () {
                                        context.pushNamed('Biwuyeirughjfsgadfjh').then((_) => setState(() {}));
                                      },
                                      child: Image.asset(
                                    ...
                                    GestureDetector(
                                      onTap: () async {
                                        context.pushNamed('Fwuigheijwhbhjnsbdxc').then((_) => setState(() {}));
                                      },
                                      child: Image.asset(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: GestureDetector(
                                        onTap: () {
                                          context.pushNamed('Ihtguehywrghjdfsbhjxbhc', queryParameters: {'syuehjsxdbhvhjas': VqweghvhjvjGvhgavsufvhg().xmcvklhjdjkrhjktg.idshgdhxcvgasd.toString()});
                                        },
                                        child: Container(
                                          width: 70,
                                          height: 32,
