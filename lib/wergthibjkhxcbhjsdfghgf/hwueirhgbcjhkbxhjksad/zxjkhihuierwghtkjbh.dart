                              ...
                              Padding(
                                ...
                                child: GestureDetector(
                                  onTap: () {
                                    ...
                                    final xbhjfwgshj = VqweghvhjvjGvhgavsufvhg()
                                        .ewrhfjkdshvjkhsd
                                        .firstWhere((item) => item.idshgdhxcvgasd == VqweghvhjvjGvhgavsufvhg().xmcvklhjdjkrhjktg.idshgdhxcvgasd)
                                        .uysagyueghsvh!;
                                    if (xbhjfwgshj < 30) {
                                      context.pushNamed('Ywqghufybzhjxcvhgvs');
                                    }
                                    VqweghvhjvjGvhgavsufvhg().ewrhfjkdshvjkhsd.firstWhere((item) => item.idshgdhxcvgasd == VqweghvhjvjGvhgavsufvhg().xmcvklhjdjkrhjktg.idshgdhxcvgasd).uysagyueghsvh =
                                        xbhjfwgshj - 30;
                                    ...
                                    context.pushNamed('Dwerusghjbhjsdrfgdfsg', queryParameters: {
                                      'sbdhjbxchvgyerdfsg': yfghsvghvxczvbhfsdhqw!.text,
                                    });
                                  },
                                  child: Image.asset(
