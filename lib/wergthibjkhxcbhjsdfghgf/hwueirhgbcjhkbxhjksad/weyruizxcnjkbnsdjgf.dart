...
class _FwuigheijwhbhjnsbdxcState extends State<Fwuigheijwhbhjnsbdxc> {
  ...
  Hugweuhghjsvhjas? ewrtdjfbjsbhjv = Hugweuhghjsvhjas(
    oiuwyeqhgsdhjf: 'https://huanniuchat.oss-accelerate-overseas.aliyuncs.com/micos/erghdbfhsjbhkqde/sishenxwsehuigsadh%403x.png',
    ureghdshjcbhjs: 'https://huanniuchat.oss-accelerate-overseas.aliyuncs.com/micos/erghdbfhsjbhkqde/sisehn1sdhshgdhfjgsad%403x.png',
    shdurghergthsd: 'https://huanniuchat.oss-accelerate-overseas.aliyuncs.com/micos/erghdbfhsjbhkqde/sishne2xhcjvjgehwfr%403x.png',
  );
                      ...
                      children: [
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: PageView.builder(
                                      ...
                                      onPageChanged: (value) {
                                        ewrtdjfbjsbhjv = uwqgehvshjvghzsvxcytry[value];
                                        setState(() {});
                                      },
                        ...
                        Padding(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              final kowerhbdsfjv = VqweghvhjvjGvhgavsufvhg().xmcvklhjdjkrhjktg;
                              VqweghvhjvjGvhgavsufvhg().ewrhfjkdshvjkhsd.firstWhere((item) => item.idshgdhxcvgasd == kowerhbdsfjv.idshgdhxcvgasd).jueskijseguhisgdhjsd = ewrtdjfbjsbhjv?.oiuwyeqhgsdhjf;
                              VqweghvhjvjGvhgavsufvhg().ewrhfjkdshvjkhsd.firstWhere((item) => item.idshgdhxcvgasd == kowerhbdsfjv.idshgdhxcvgasd).xhughugrvehgdvf = ewrtdjfbjsbhjv?.shdurghergthsd;
                              VqweghvhjvjGvhgavsufvhg().xmcvklhjdjkrhjktg = VqweghvhjvjGvhgavsufvhg().ewrhfjkdshvjkhsd.firstWhere((item) => item.idshgdhxcvgasd == kowerhbdsfjv.idshgdhxcvgasd);
                              context.pop();
                            },
                            child: Image.asset(
